...
module.exports = {
    ...
    chainWebpack: config => {
        ...
        config.plugin('define').tap(args => {
            ...
            env.VUE_APP_CABINET_APP_SERVICE = JSON.stringify(process.env.CABINET_APP_SERVICE || 'index/service/');
            env.VUE_APP_NAME_APP = JSON.stringify(process.env.VUE_APP_NAME_APP);
            env.VUE_APP_DEBUG = JSON.stringify(process.env.VUE_APP_DEBUG);
            env.VUE_APP_BY_CREATED_PDF = JSON.stringify(process.env.VUE_APP_BY_CREATED_PDF);
            return args;
        });
    },
