...
class SubjectHelperSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('subject_helpers')->insert([
            ...
            [
                'title' => 'Здатність мотивувати людей та рухатися до спільної мети',
                'catalog_helper_type_id' => 1
            ],
            [
                'title' => 'Знати сутність та специфіку корпоративної культури, форми її виявлення та методи формування; розуміти роль мети і цінностей у формуванні корпоративної культури; визначати ознаки сильної корпоративної культури; використовувати корпоративну культуру для зростання іміджу організації та її цільності',
                'catalog_helper_type_id' => 2
            ],
            [
                'title' => 'Лекції, семінари, проблемні заняття',
            ...
            [
                'title' => 'Базове (шкільне) знання предметів/Аудиторія мультимед.',
                'catalog_helper_type_id' => 4
            ],
        ]);
    }
