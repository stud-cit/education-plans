...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('settings')->insert([
            ...
            ['key' => 'min-classroom-load', 'title' => 'Мінімальне аудиторне навантаження по дисципліні', 'value' => 2],
            ['key' => 'max-classroom-load', 'title' => 'Максимальне аудиторне навантаження по дисципліні', 'value' => 4],
        ]);
    }
}
